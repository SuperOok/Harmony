...
**Status: Stichprobe, nicht vollständig.** Diese Karten dienen der Erprobung
der Notation. Die systematische Erfassung aller 32 Karten beginnt laut
`00-methodik.md` erst nach dem Durchstich aus Phase 6.
